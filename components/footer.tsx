...
export default function FooterSection() {
    return (
        <footer className="py-2 md:py-4 mx-auto max-w-5xl px-6 ">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                
                <div>

                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} @Jarek, All rights reserved</span>
